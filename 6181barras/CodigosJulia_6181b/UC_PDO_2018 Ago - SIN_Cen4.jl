...
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_UCT_GerCSV_SIN.csv", PI, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_UCH_GerCSV_SIN.csv", GI, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_UCT_ResUP_SIN.csv", RUP, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_UCT_ResDN_SIN.csv", RDN, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_UCH_X_SIN.csv", X, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_Vol.csv", VOL, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_PcutEOL_SIN.csv", PcutEOL, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_PcutUFV_SIN.csv", PcutUFV, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_GerEOLSup_SIN.csv", Psup_eol, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_GerUFVSup_SIN.csv", Psup_ufv, ',') #### exporta para arquivo .csv
# #writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_GerEOLInf_SIN.csv", Pinf_eol, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_CI_nsimu_SIN.csv", CI_nsimu, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-DemandaLiq_SIN.csv", d, ',') #### demanda líquida
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-DemandaBrut_SIN.csv", dbrut, ',') #### demanda bruta
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_ploadrcbrut.csv", pload_rbrut, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_ploadrcliq.csv", pload_r, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_rdnh.csv", RDNH, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_ruph.csv", RUPH, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_Z.csv", Z, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4-Result_FCF.csv", ALPHA, ',') #### exporta para arquivo .csv
...
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_UCT_GerCSV_SIN.csv", results_ute, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_UCH_GerCSV_SIN.csv", Ger_hidrTR, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_PcutEOL_SIN.csv", PcutEOL2, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_PcutUFV_SIN.csv", PcutUFV2, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_VerEOL_SIN.csv", Ver_eol, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_VerUFV_SIN.csv", Ver_ufv, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-DemandaVerLiq_SIN.csv", d_ver, ',') #### demanda líquida
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-CorteCarga_SIN.csv", Corte_carga, ',') #### corte de carga de d_ver
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_ploadrcliq.csv", pload_r, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_CorteCargabus.csv", Corte_carga_bus, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_Z2.csv", Z2, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_FCF2.csv", ALPHA, ',') #### exporta para arquivo .csv
...
# PcutEOL2          = CSV.read(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_PcutEOL_SIN.csv",DataFrame,header=false)
# PcutUFV2          = CSV.read(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_PcutUFV_SIN.csv",DataFrame,header=false)
...
# Z2      = CSV.read(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_Z2.csv",DataFrame,header=false)
# ALPHA     = CSV.read(scriptPath * "/RESULTADOS/Caso4/Caso4_Ver-Result_FCF2.csv",DataFrame,header=false)
