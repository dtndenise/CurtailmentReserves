...
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_UCT_GerCSV_SIN.csv", PI, ',')
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_UCH_GerCSV_SIN.csv", GI, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_UCT_ResUP_SIN.csv", RUP, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_UCT_ResDN_SIN.csv", RDN, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_UCH_ResUP_SIN.csv", RUPH, ',')
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_UCH_ResDN_SIN.csv", RDNH, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_UCH_X_SIN.csv", X, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_UCH_VOL_SIN.csv", VOL, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_PcutEOL_SIN.csv", PcutEOL, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_PcutUFV_SIN.csv", PcutUFV, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_GerEOLSup_SIN.csv", Psup_eol, ',')
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_GerUFVSup_SIN.csv", Psup_ufv, ',')
# #writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso4-Result_GerEOLInf_SIN.csv", Pinf_eol, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_CI_nsimu_SIN.csv", CI_nsimu, ',')

# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_DemandaLiq_SIN.csv", d, ',') #### demanda líquida
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_DemandaBrut_SIN.csv", dbrut, ',') #### demanda bruta
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_ploadrcbrut.csv", pload_rbrut, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_ploadrcliq.csv", pload_r, ',')
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_Z.csv", Z, ',') 
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Result_FCF.csv", ALPHA, ',') 
...
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_UCT_GerCSV_SIN.csv", results_ute, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_UCH_GerCSV_SIN.csv", Ger_hidrTR, ',') #### exporta para arquivo .csv

# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_PcutEOL_SIN.csv", PcutEOL2, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_PcutUFV_SIN.csv", PcutUFV2, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_VerEOL_SIN.csv", Ver_eol, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_VerUFV_SIN.csv", Ver_ufv, ',') #### exporta para arquivo .csv

# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-DemandaVerLiq_SIN.csv", d_ver, ',') #### demanda líquida
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-CorteCarga_SIN.csv", Corte_carga, ',') #### corte de carga de d_ver
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_ploadrcliq.csv", pload_r, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_CorteCargabus.csv", Corte_carga_bus, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_Z2.csv", Z2, ',') #### exporta para arquivo .csv
# writedlm(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_FCF2.csv", ALPHA, ',') #### exporta para arquivo .csv
...
# PcutEOL2          = CSV.read(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_PcutEOL_SIN.csv",DataFrame,header=false)
# PcutUFV2          = CSV.read(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_PcutUFV_SIN.csv",DataFrame,header=false)
...
# Z2      = CSV.read(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_Z2.csv",DataFrame,header=false)
# ALPHA     = CSV.read(scriptPath * "/RESULTADOS/Caso1b/Caso1b_Ver-Result_FCF2.csv",DataFrame,header=false)
