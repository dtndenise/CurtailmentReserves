...
#########################################
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_PcutEOL.csv", PcutEOL, ',') 
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_dliq.csv", d, ',')  
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_dbrut.csv", dbrut, ',')  
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_pload_brut.csv", pload_rbrut, ',')  
# pload_rliqfinal = pload_rbrut - pload_rliq
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_GerEolSup.csv", Psup_eol, ',') 
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_GerEolInf.csv", Pinf_eol, ',') 
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UTEGer.csv", PI, ',')  
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UHEGer.csv", GI, ',')  
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UCT-ReserveUP.csv", RUP, ',')  
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UCH_ReserveUP.csv", RUPH, ',')  
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UCH_ReserveDN.csv", RDNH, ',')
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_XUHE.csv", X, ',')  
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_VolUHE.csv", VOL, ',')  
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_Z.csv", Z, ',') 
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_ALPHA.csv", ALPHA, ',') 

# #-------------------------------------------------------------------
# # Leitura dos resultados - Caso 5

# PI       = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UTEGer.csv",DataFrame,header=false)
# GI       = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UHEGer.csv",DataFrame,header=false)
# RUP      = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UCT-ReserveUP.csv",DataFrame,header=false)
# RUPH     = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UCH_ReserveUP.csv",DataFrame,header=false)
# RDNH     = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UCH_ReserveDN.csv",DataFrame,header=false)
# X        = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_XUHE.csv",DataFrame,header=false)
# VOL       = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_VolUHE.csv",DataFrame,header=false)
# PcutEOL  = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_PcutEOL.csv",DataFrame,header=false)
# Psup_eol  = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_GerEolSup.csv",DataFrame,header=false)
# Pinf_eol  = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_GerEolInf.csv",DataFrame,header=false)
# d         = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_dliq.csv",DataFrame,header=false)
# dbrut     = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_dbrut.csv",DataFrame,header=false)
# pload_rbrut = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_pload_brut.csv",DataFrame,header=false)
# Z      = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_Z.csv",DataFrame,header=false)
# ALPHA     = CSV.read(scriptPath * "/Resultados/Caso5/Result30b_Caso5_ALPHA.csv",DataFrame,header=false)
...
# Exportação dos resultados 
#########################################
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_PcutEOL2_Ver.csv", PcutEOL2, ',') 
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_GerEolSup_Ver.csv", Ver_eol, ',') 

# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_dbrut_Ver.csv", dbrut_ver, ',') 
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_CorteCarga_Ver.csv", Corte_carga, ',') 
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_CorteCargaBus_Ver.csv", Corte_carga_bus, ',') 

# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_UHEGer_Ver.csv", Ger_hidrTR, ',')
# writedlm(scriptPath * "/Resultados/Caso5/Result30b_Caso5_Z2_Ver.csv", Z2, ',')
