...
#########################################
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_PcutEOL.csv", PcutEOL, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_dliq.csv", d, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_dbrut.csv", dbrut, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_pload_brut.csv", pload_rbrut, ',')  
# pload_rliqfinal = pload_rbrut - pload_rliq
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_GerEolSup.csv", Psup_eol, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_GerEolInf.csv", Pinf_eol, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UTEGer.csv", PI, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UHEGer.csv", GI, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UCT-ReserveUP.csv", RUP, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UCT_ReserveDN.csv", RDN, ',')
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UCH_ReserveUP.csv", RUPH, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UCH_ReserveDN.csv", RDNH, ',')
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_XUHE.csv", X, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_VolUHE.csv", VOL, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_Z.csv", Z, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_ALPHA.csv", ALPHA, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_SENS.csv", β_b, ',') 

#-------------------------------------------------------------------
# Leitura dos resultados - Caso 1b

# PI       = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UTEGer.csv",DataFrame,header=false)
# GI       = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UHEGer.csv",DataFrame,header=false)
# RUP      = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UCT-ReserveUP.csv",DataFrame,header=false)
# RUPH     = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UCH_ReserveUP.csv",DataFrame,header=false)
# RDNH     = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UCH_ReserveDN.csv",DataFrame,header=false)
# X        = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_XUHE.csv",DataFrame,header=false)
# VOL       = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_VolUHE.csv",DataFrame,header=false)
# PcutEOL  = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_PcutEOL.csv",DataFrame,header=false)
# Psup_eol  = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_GerEolSup.csv",DataFrame,header=false)
# Pinf_eol  = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_GerEolInf.csv",DataFrame,header=false)
# d         = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_dliq.csv",DataFrame,header=false)
# dbrut     = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_dbrut.csv",DataFrame,header=false)
# pload_rbrut = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_pload_brut.csv",DataFrame,header=false)
# Z      = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_Z.csv",DataFrame,header=false)
# ALPHA     = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_ALPHA.csv",DataFrame,header=false)
...
#-------------------------------------------------------------------------
println("========== Métricas de desempenho 30barras - Caso 2 Verificado ==============")
...
# Exportação dos resultados 
#########################################
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_PcutEOL2_Ver.csv", PcutEOL2, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_GerEolSup_Ver.csv", Ver_eol, ',') 

# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_dbrut_Ver.csv", dbrut_ver, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_CorteCarga_Ver.csv", Corte_carga, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_CorteCargaBus_Ver.csv", Corte_carga_bus, ',') 

# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UHEGer_Ver.csv", Ger_hidrTR, ',')
# writedlm(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_Z2_Ver.csv", Z2, ',')

# #-------------------------------------------------------------------
# # Leitura dos resultados - Caso 1b

# PcutEOL2        = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_PcutEOL2_Ver.csv",DataFrame,header=false)
# Ver_eol         = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_GerEolSup_Ver.csv",DataFrame,header=false)
# dbrut_ver       = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_dbrut_Ver.csv",DataFrame,header=false)
# Corte_carga     = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_CorteCarga_Ver.csv",DataFrame,header=false)
# Corte_carga_bus = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_CorteCargaBus_Ver.csv",DataFrame,header=false)
# Ger_hidrTRZ     = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_UHEGer_Ver.csv",DataFrame,header=false)
# Z2              = CSV.read(scriptPath * "/Resultados/RPOzero//Caso1b/Result30b_Caso1b_Z2_Ver.csv",DataFrame,header=false)
