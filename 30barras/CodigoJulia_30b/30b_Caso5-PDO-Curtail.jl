...
#########################################
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_PcutEOL.csv", PcutEOL, ',') 
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_dliq.csv", d, ',')  
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_dbrut.csv", dbrut, ',')  
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_pload_brut.csv", pload_rbrut, ',')  
# pload_rliqfinal = pload_rbrut - pload_rliq
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_GerEolSup.csv", Psup_eol, ',') 
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_GerEolInf.csv", Pinf_eol, ',') 
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UTEGer.csv", PI, ',')  
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UHEGer.csv", GI, ',')  
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UCT-ReserveUP.csv", RUP, ',')  
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UCT_ReserveDN.csv", RDN, ',')
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UCH_ReserveUP.csv", RUPH, ',')  
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UCH_ReserveDN.csv", RDNH, ',')
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_XUHE.csv", X, ',')  
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_VolUHE.csv", VOL, ',')  
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_Z.csv", Z, ',') 
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_ALPHA.csv", ALPHA, ',') 
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_SENS.csv", β_b, ',') 

# #-------------------------------------------------------------------
# # Leitura dos resultados - Caso 4

# PI       = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UTEGer.csv",DataFrame,header=false)
# GI       = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UHEGer.csv",DataFrame,header=false)
# RUP      = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UCT-ReserveUP.csv",DataFrame,header=false)
# RUPH     = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UCH_ReserveUP.csv",DataFrame,header=false)
# RDNH     = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UCH_ReserveDN.csv",DataFrame,header=false)
# X        = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_XUHE.csv",DataFrame,header=false)
# VOL       = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_VolUHE.csv",DataFrame,header=false)
# PcutEOL  = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_PcutEOL.csv",DataFrame,header=false)
# Psup_eol  = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_GerEolSup.csv",DataFrame,header=false)
# Pinf_eol  = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_GerEolInf.csv",DataFrame,header=false)
# d         = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_dliq.csv",DataFrame,header=false)
# dbrut     = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_dbrut.csv",DataFrame,header=false)
# pload_rbrut = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_pload_brut.csv",DataFrame,header=false)
# Z      = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_Z.csv",DataFrame,header=false)
# ALPHA     = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_ALPHA.csv",DataFrame,header=false)
...
# Exportação dos resultados 
#########################################
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_PcutEOL2_Ver.csv", PcutEOL2, ',') 
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_GerEolSup_Ver.csv", Ver_eol, ',') 

# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_dbrut_Ver.csv", dbrut_ver, ',') 
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_CorteCarga_Ver.csv", Corte_carga, ',') 
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_CorteCargaBus_Ver.csv", Corte_carga_bus, ',') 

# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UHEGer_Ver.csv", Ger_hidrTR, ',')
# writedlm(scriptPath * "/Resultados/Caso4/Result30b_Caso4_Z2_Ver.csv", Z2, ',')

# #-------------------------------------------------------------------
# # Leitura dos resultados - Caso 4

# PcutEOL2        = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_PcutEOL2_Ver.csv",DataFrame,header=false)
# Ver_eol         = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_GerEolSup_Ver.csv",DataFrame,header=false)
# dbrut_ver       = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_dbrut_Ver.csv",DataFrame,header=false)
# Corte_carga     = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_CorteCarga_Ver.csv",DataFrame,header=false)
# Corte_carga_bus = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_CorteCargaBus_Ver.csv",DataFrame,header=false)
# Ger_hidrTRZ     = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_UHEGer_Ver.csv",DataFrame,header=false)
# Z2              = CSV.read(scriptPath * "/Resultados/Caso4/Result30b_Caso4_Z2_Ver.csv",DataFrame,header=false)
