...
for w = 1:n_eol
    for t = 1:pat
        if oper_eol[w, 8] == "S"
            kappa_eol_ResUP[w, t] = 0.31
            kappa_eol_ResDN[w, t] = 0.31
        elseif oper_eol[w, 8] == "NE"
            kappa_eol_ResUP[w, t] = 0.1
            kappa_eol_ResDN[w, t] = 0.1
        end
    end
end
...
#-------------------------------------------------------------------------------
    ...
    # Reservas hidráulicas fixas (Caso 3)
...
# Resultados
#-------------------------------------------------------------------------
println("======== Resultados 30b - Caso 3 (fixed res and curtail) =========")
...
#########################################
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_PcutEOL.csv", PcutEOL, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_dliq.csv", d, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_dbrut.csv", dbrut, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_pload_brut.csv", pload_rbrut, ',')  
# pload_rliqfinal = pload_rbrut - pload_rliq
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_GerEolSup.csv", Psup_eol, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_GerEolInf.csv", Pinf_eol, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UTEGer.csv", PI, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UHEGer.csv", GI, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UCT-ReserveUP.csv", RUP, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UCT_ReserveDN.csv", RDN, ',')
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UCH_ReserveUP.csv", RUPH, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UCH_ReserveDN.csv", RDNH, ',')
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_XUHE.csv", X, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_VolUHE.csv", VOL, ',')  
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_Z.csv", Z, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_ALPHA.csv", ALPHA, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_SENS.csv", β_b, ',') 

# #-------------------------------------------------------------------
# # Leitura dos resultados - Caso 2

# PI       = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UTEGer.csv",DataFrame,header=false)
# GI       = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UHEGer.csv",DataFrame,header=false)
# RUP      = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UCT-ReserveUP.csv",DataFrame,header=false)
# RUPH     = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UCH_ReserveUP.csv",DataFrame,header=false)
# RDNH     = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UCH_ReserveDN.csv",DataFrame,header=false)
# X        = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_XUHE.csv",DataFrame,header=false)
# VOL       = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_VolUHE.csv",DataFrame,header=false)
# PcutEOL  = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_PcutEOL.csv",DataFrame,header=false)
# Psup_eol  = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_GerEolSup.csv",DataFrame,header=false)
# Pinf_eol  = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_GerEolInf.csv",DataFrame,header=false)
# d         = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_dliq.csv",DataFrame,header=false)
# dbrut     = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_dbrut.csv",DataFrame,header=false)
# pload_rbrut = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_pload_brut.csv",DataFrame,header=false)
# Z      = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_Z.csv",DataFrame,header=false)
# ALPHA     = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_ALPHA.csv",DataFrame,header=false)
...
#-------------------------------------------------------------------------
println("========== Métricas de desempenho 30barras - Caso 3 Verificado ==============")
...
# Exportação dos resultados 
#########################################
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_PcutEOL2_Ver.csv", PcutEOL2, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_GerEolSup_Ver.csv", Ver_eol, ',') 

# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_dbrut_Ver.csv", dbrut_ver, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_CorteCarga_Ver.csv", Corte_carga, ',') 
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_CorteCargaBus_Ver.csv", Corte_carga_bus, ',') 

# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UHEGer_Ver.csv", Ger_hidrTR, ',')
# writedlm(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_Z2_Ver.csv", Z2, ',')

# #-------------------------------------------------------------------
# # Leitura dos resultados - Caso 2

# PcutEOL2        = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_PcutEOL2_Ver.csv",DataFrame,header=false)
# Ver_eol         = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_GerEolSup_Ver.csv",DataFrame,header=false)
# dbrut_ver       = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_dbrut_Ver.csv",DataFrame,header=false)
# Corte_carga     = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_CorteCarga_Ver.csv",DataFrame,header=false)
# Corte_carga_bus = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_CorteCargaBus_Ver.csv",DataFrame,header=false)
# Ger_hidrTRZ     = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_UHEGer_Ver.csv",DataFrame,header=false)
# Z2              = CSV.read(scriptPath * "/Resultados/RPOzero/Caso2/Result30b_Caso2_Z2_Ver.csv",DataFrame,header=false)
